...
RSpec.describe Baseballbot::Template::Sidebar::Leaders do
  describe '#hitter_stats' do
    it 'loads stuff' do
      ...
      account = Baseballbot::Account.new bot: bot, name: 'RSpecTestBot', access: ''
      subreddit = Subreddit.new({ name: 'dodgers', team_code: 'LAD', team_id: 119 }, bot: bot, account: account)
      thing = Subject.new(subreddit: subreddit)
