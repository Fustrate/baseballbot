...
1	2022-05-17 17:10:00	2022-05-17 15:10:00	Future	\N	\N	2022-05-15 11:12:17.124634	2022-05-15 11:12:17.136276	15	663032	\N	\N	\N
...
8	miamimarlins	MIA	9	{"sidebar": {"enabled": true}, "timezone": "America/New_York", "game_threads": {"title": {"default": "Game Thread: %-m/%-d %<away_name>s (%<away_record>s) @ %<home_name>s (%<home_record>s) %<start_time>s"}, "enabled": true, "post_at": "-3"}}	146	\N	{}
...
19	azdiamondbacks	AZ	19	{"sidebar": {"enabled": true}, "postgame": {"title": {"default": "POSTGAME THREAD %-m/%-d - %<away_name>s (%<away_record>s) @ %<home_name>s (%<home_record>s)"}, "enabled": true}, "timezone": "America/Phoenix", "game_threads": {"title": {"default": "GAME THREAD: %<away_name>s (%<away_record>s) @ %<home_name>s (%<home_record>s) - %<start_time>s"}, "enabled": true}}	109	\N	{}
