...
RSpec.describe Redd::Client do
  describe '#get' do
    it 'makes a GET request' do
      ...
      described_class.new(endpoint: 'https://test.com').get('/get_request', param: 1)
  ...
  describe '#post' do
    it 'makes a POST request' do
      ...
      described_class.new(endpoint: 'https://test.com').post('/post_request', param: 1)
  ...
  describe '#put' do
    it 'makes a PUT request' do
      ...
      described_class.new(endpoint: 'https://test.com').post('/put_request', param: 1)
  ...
  describe '#patch' do
    it 'makes a PATCH request' do
      ...
      described_class.new(endpoint: 'https://test.com').patch('/ptch_request', param: 1)
  ...
  describe '#delete' do
    it 'makes a DELETE request' do
      ...
      described_class.new(endpoint: 'https://test.com').delete('/del_request', param: 1)
